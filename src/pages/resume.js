    ...
    <div className="wrapper">
      <div className="inner">
        ...
        <ul>
          ...
          <li>
            Custom theme development for WordPress and Drupal based sites for
            APIHub, NextDeal, Programmable Web, Digital Closing Docs, Sassy
            Pants Boutique, and Digimation.
          </li>
          <li>
        ...
        <h3 className="major">
          Digitec Interactive, Orlando, FL — <em>Senior Software Developer</em>
        </h3>
        ...
        <h3 className="major">
          Digital Closing Docs, Orlando, FL — <em>Full Stack Web Developer</em>
        </h3>
        <h4>February 2017 – February 2018</h4>
        <ul>
          <li>
            Developed multi-page web forms for title agencies with Parsley.js
            validation, custom JavaScript to pre-populate values from the MySQL
            database, and integration with HelloSign for document signing.
          </li>
          <li>Created cross-platform consistent email newsletter templates.</li>
        </ul>
        ...
        <ul>
          <li>
            Developed new, custom adaptive Drupal 6 theme for GolfChannel.com.
          </li>
          <li>
          ...
          <li>
            Brought consistent user experiences to .NET based Fantasy golf game.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>Worked on the Online Account website for timeshare owners.</li>
          <li>
        ...
        <ul>
          ...
          <li>
            ...
            Challenge 2013, Destination and Resort Finder for Islands Magazine,
            Event calendar for Florida Travel &amp; Life.
          </li>
          <li>
        ...
        <ul>
          <li>
            Small business IT administration including server, networking, and
            end user support.
          </li>
          <li>
          ...
          <li>
            Developed web sites for Digimation, Morse Agency, City of Debary,
            Hard Knocks Orlando, Sassy Pants Orlando, Wolf, Hill, McFarlin, and
            Herron, and Morse Insurance Agency.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            ...
            Group, MVP Sportsplex, Lake Nona Golf &amp; Country Club and Rollins
            College.
          </li>
          <li>
            Mixed environment server administrator for web hosting and internal
            development.
          </li>
        </ul>
      </div>
